...
scMusicOne = \shiftDurations #1 #0 {  \relative c'' {  
...
scMusicTwo =  \shiftDurations #1 #0 { \relative c' {  
R\breve r1 d1 ~ d1 g,1 d'1. d2 ef2 ef d1 r2 d2 bf2 c d2. d4 d2 a2 bf2 d1 cs4[ b] 
...
d'1 c2 a2 bf2 c2 d4 [ \melisma c] d[ e ] f2. e8[ f] g2 \melismaEnd f4 [ e4 ] d1 r2 a2 
...
scMusicThree =  \shiftDurations #1 #0 { \relative c' {  
R\breve*7 r1 
...
scMusicFour = \shiftDurations #1 #0 {  \relative c {  
R\breve R R R 
R R R R 
