...
SanctusSopranoNotes =  \relative b' {
  ...
  r2 fs2 g2. g4 | % 395
  e2 a2. \melisma g4 g2 \melismaEnd | % 396
  fs2 e2 g1 ~ | % 397
  g1 r2 b2 | % 398
  c2. c4 a2 b2 ~ | % 399
  b4 \melisma a4 a1 \melismaEnd gs2 | \barNumberCheck #61
  a\breve | % 401
  r2 e2 ^\markup{ \column { (faster) " " }}  g2. a4 | % 402
  b2 g2 d'1 | % 403
  a2 b2. b4 c2 ~ | % 404
...
SanctusTenorNotes =  \relative b {
  ...
  fs1 r2 b2 | % 395
  c2. c4 a2 d2 ~ | % 396
  d4 \melisma c4 c1 b4 \melismaEnd a4 | % 397
  b1 b2 e2 ~ | % 398
  e4 e4 c1 d2 ~ | % 399
