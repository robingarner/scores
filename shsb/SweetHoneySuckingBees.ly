...
PartPOneVoiceOne =  \relative c'' {
    ...
    as4 as4 g4 f4 | % 32
    e2. g4 \p | % 33
    as8  [ \melisma g8 as8 bes8 ] c4 \melismaEnd bes8 [ as8 ] | % 34
    bes8 [ \melisma as8 bes8 c8 ] bes4 \melismaEnd es4 | % 35
    ...
    as2. g4 | % 56
    f2. es8 [ des8 ] | % 57
    es2. \melisma des8 [ c8 ] | % 58
    des2. \melismaEnd des4 | % 59
    ...
    r4 es4 \f c4 f4 | % 121
    es8 [ \melisma des8 es8 f8 ] es4. \melismaEnd des8 | % 122
    c2 c4 c8 bes8 | % 123
...
PartPOneVoiceOneLyricsOne =  \lyricmode { 
    Sweet hon -- ey suck -- ing    bees 
    sweet hon -- ey  suck -- ing bees 
    why do you still why do you still, 
    why do you still sur -- feit on ro -- ses, pinks and vi -- o -- lets; 
    as if the choic -- est nec -- tar lay in _ them, 
    Where -- with you store, 
    where -- with you store, 
    where -- with you store your cur -- ious ca -- bin -- _ ets? 
    Ah, make your flight __ _ _ _ _ 
    ah, make your flight, __ _ _ _ _ 
    ah, make your flight, 
    ah, make your flight __ _ _ _ _ to Me -- li -- sua -- via's lips. 
    There, there may you re -- vel in am -- bro -- sian cheer, 
    Where smi -- _ _ _ _ ling  _  ro -- _ _ _ _ ses and sweet lil -- lies sit, 
    there may you re -- vel,
    
    Keep -- ing their spring -- tide, 
    keep -- ing their spring -- _ tide gra -- ces, 
    keep -- ing their spring -- tide gra -- ces all the year, 
    keep -- ing their spring -- tide gra -- ces _ all __ _ _ _ the year, 
    keep -- ing their spring -- tide gra -- ces all _ the _ year.
    
    Yet, sweet, take heed, all sweets are hard to get;
    Sting _ not, sting _ not her soft lips; 
    Oh, be -- ware of that, Oh, be -- ware of that, 
    Oh, be -- ware of that, Oh, be -- ware of that,
    Oh, _ Oh, _ be -- ware _ of that, 
    
    For if one flam -- _ _ _ _ ing dart come from her eye, 
    come from her eye, come from her eye, 
    ...
    ah, _ then you die _ then you die __ _ then you die, ah _ then you
    die, then you die, you die, 
    
    was ne -- ver dart so sharp, 
    was ne -- ver dart so sharp, __ _ _ 
    ah, then you die, ah, __ _ then you
...
PartPTwoVoiceOne =  \relative c'' {
    ...
    c4 c4 bes4 as4 | % 32
    g2. c4 \p | % 33
    c8 [ \melisma bes8 as8 g8 ] as4 \melismaEnd g8 [ f8 ] | % 34
    g8 [ \melisma f8 g8 as8 ] g4 \melismaEnd c4 | % 35
    bes4 as4 as4 g4 | % 36
    as1 | % 37
    c2 \f c4 c4 | % 38
    c2 c2 | % 39
    ...
    r2 r4 es4 ~ | % 55
    es8 [ es8 ] des4 c2 ~ | % 56
    c4 bes8 [ \melisma as8 ] \melismaEnd bes2 ~ | % 57
    bes4 as4 as2 ~ | % 58
    as4 g8 [ \melisma f8 ] g2 \melismaEnd | % 59
    ...
    c8 [ \melisma bes8 c8 des8 ] c4 \melismaEnd bes4 | % 122
    as2 as4 as8 g8 | % 123
...
PartPTwoVoiceOneLyricsOne =  \lyricmode { 
  ...
  why do you still, 
  why do you still sur -- feit on ro -- ses, pinks and vi -- o -- lets; 
  As if the choic -- est nec -- tar __ _ _ _ lay __ _ _ _ _ in them, 
  where -- with you store your cur -- ious ca -- bin -- ets? 
  Ah, make your flight __ _ _ _ _  to Me -- li -- sua -- via's lips, 
  ah, make your flight __ _ _ _ _ _ to Me -- li -- sua -- via's lips __ _ 
  There may you re -- vel, there
    may you re -- vel in am -- bro -- sian cheer, 
  Where smi -- _ _ _ _ ling _ ro -- _ _ _ _ ses and sweet lil -- lies sit, 
  there may you re -- vel, 
  Keep -- _ ing their spring -- tide gra -- ces 
  keep -- ing their spring -- _ tide gra -- ces 
  keep -- ing their spring -- tide gra -- ces all the year,
  keep -- _ ing their spring -- _ tide _ gra -- _ ces all _ the __ _ _ year,
  keep -- ing their spring -- tide spring -- tide gra -- ces all the year.  __ _ 
  ...
  Yet, sweet, take heed, all sweets are hard to get.
    ...
    sharp, ah, _ then you die _ then you die, __ _ then you die, ah then you
    die __ _ then _ you die 
    
    was ne -- ver dart so sharp, ah _ then you
    die, ah, then you die, __ _ you die, ah, __ _ then you die.
...
PartPThreeVoiceOne =  \relative f' {
    ...
    e2 g2 \p | % 41
    as8 [ \melisma g8 as8 bes8 ] c4 \melismaEnd bes8 [ c8 ] | % 42
    bes8 [ \melisma as8 bes8 c8 ] bes4 \melismaEnd es4 | % 43
    ...
    f2. es4 | % 56
    des2. c8 [ bes8 ] | % 57
    c2. \melisma bes8 [ as8 ] | % 58
    bes2. \melismaEnd bes4 | % 59
    ...
    f1 | % 78
    g2 f2 ~ \melisma | % 79
    f2 e2 \melismaEnd | \barNumberCheck #80
    f1 | % 81
    g2 f2 ~ \melisma | % 82
    f2 e2 \melismaEnd | % 83
    ...
    as,1 | % 107
    r4 es'4 \f c4 f4 | % 108
    es8 [ \melisma des8 es8 f8 ] es4. \melismaEnd des8 | % 109
...
PartPThreeVoiceOneLyricsOne =  \lyricmode { 
  Sweet hon -- ey suck --
    ing bees, sweet hon -- ey  suck -- ing bees, 
  why do you still, why
    do you still, why do you still sur -- feit on ro -- ses, pinks and vi -- o --
    lets; 
  As if the choic -- est nec -- tar lay in them, 
  Where -- with you store your cur -- ious ca -- bi -- _ nets, 
  your cur -- ious ca -- _ _ _ _ bi -- nets?
  Ah, make your flight __ _ _ _ _ 
  ah, make your flight __ _ _ _ _ 
  ah! make your
    flight __ _ _ _ _ 
  There may you re -- vel, there may you re -- vel, there,
    there may you re -- vel, there may you re -- vel, 
  there may you re -- vel in am -- bro -- sian cheer, 
  where smil -- _ _ _ _ ing _ ro -- _ _ _ _ ses and sweet lil -- lies sit, 
  keep -- _ ing their spring -- tide gra -- ces
  keep -- ing their spring -- tide gra -- _ ces all _ the year, 
  their spring -- tide gra -- ces all the year, all the year, 
  keep -- ing their spring -- tide gra -- ces _ all __ _ _ _ the year, 
  keep -- _ ing their spring -- _ tide _ gra -- _ ces all the year, 
  keep -- ing their spring -- tide spring -- tide gra -- ces all the year.  __ _ 
    
    Yet, sweet take heed, yes, sweet, take heed, 
    all sweets are hard to get, all sweets are _ hard to get; 
    Sting not her soft __ _  _ lips, her soft __ _ _ lips; 
    ...
    dart _ was ne -- ver dart so sharp, was ne -- ver dart so sharp _
    then you die, ah, then you die, ah, _ then you die,
...
PartPFourVoiceOne =  \relative f' {
    ...
    g2. c4 \p | % 41
    c8 [ \melisma bes8 as8 g8 ] as4 \melismaEnd g8 [ f8 ] | % 42
    g8 [ \melisma f8 g8 as8 ] g4 \melismaEnd c4 | % 43
    bes4 as4 as4 g4 | % 44
    as2 r4 c4 ~ | % 45
    c8 [ c8 ] c4 c4 f,4 | % 46
    c'2 c2 | % 47
    ...
    as2. g4 | % 61
    f2. g4 | % 62
    e4 \melisma f2 \melismaEnd e4 | % 63
    f2 r2 | % 64
    r4 \f c'4. c8 d4 | % 65
    e2 c2 | % 66
    c2 c2 | % 67
    ...
    e2 c2 | % 77
    d1 | % 78
    e2 \melisma f2 \melismaEnd | % 79
    c1 | \barNumberCheck #80
    f,1 | % 81
    r4 g4 as4 \melisma bes4 \melismaEnd | % 82
    c2. c8 bes8 | % 83
    as4. g8 f2 | % 84
    as1 | % 85
    bes1 | % 86
    ...
    R1 | % 101
    R1*6 | % 107
    r4 c4 \f as4 des4 | % 108
    c8 [ \melisma bes8 c8 des8 ] c4 \melismaEnd bes4 | % 109
    ...
    f2 f2 | % 144
    g1 | % 145
    a4 \p \melisma bes4 c2 \melismaEnd | % 146
    c1 | % 147
    R1*2 | % 149
...
PartPFourVoiceOneLyricsOne =  \lyricmode { 
  ...
  sweet hon -- ey   suck -- ing bees, 
  why do you still, 
  why do you still sur -- feit on ro -- _ _  ses, pinks and vi -- o -- lets; 
  As if the choic -- est nec -- tar lay __ _ _  in __ _ them, 
  Where -- with you store your cur -- ious ca -- bin -- ets? __ _ 
  Ah, make your flight __ _ _ _ _ _ _ _ _ to Me -- li -- sua -- via's lips, 
  your flight __ _ _ _ _ _ _ _ _  to Me -- li -- sua -- via's lips; 
  There may you re -- vel, there may you re -- vel, 
  there may you re -- vel in _ am -- _ bro -- sian cheer, 
  Where smil -- ing ros -- es and
  sweet lil -- lies sit, there may you re -- vel, there may you re -- vel
  in am -- bro -- sian cheer, 
  where smil -- _ _ _ _ ing _ ro -- _ _ _ _ ses and
  sweet lil -- lies sit, 
  keep -- _ ing their spring -- tide gra -- ces,
  keep -- ing their spring -- tide gra -- _ ces, 
  keep -- _ ing their spring -- tide spring -- tide gra -- ces, 
  keep -- _ ing their spring -- tide
    gra -- ces keep -- ing their spring -- tide gra -- ces all _ the
    year keep -- ing their spring -- tide gra -- ces all the year.  __ _
    ...
    ah _ then you die, _ then you die, you die. 
    Was ne -- ver dart so
    sharp, was __ _ ne -- ver dart so sharp, ah, then __ _ you die,
    you die, ah, then you _ _ die, ah, ah, __ _ then you die,
...
PartPFiveVoiceOneLyricsOne =  \lyricmode { 
    Ah, make your flight __ _ _ _ _ to
    Me -- li -- sua -- vias lips, 
    Ah, make your flight __ _ _ _ _ to Me -- li --
    sua -- via's lips; __ _ There may you re -- vel, there may you
    ...
    then you die, __ _ was ne -- _ ver dart so sharp, 
    ah _ then you die, you die, __ _ _  
    ah, __ _ then you die, ah, then you
    die, ah, then you die __ _ ah, then you die. 
}
