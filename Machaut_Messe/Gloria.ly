...
PartPOneVoiceOne =  \relative a' {
    \clef "treble" \key c \major \time 4/2 | % 1
    \tempo 2=60 | % 1
    a\breve | % 2
    a\breve | % 3
    g1. e2 | % 4
    f2 gis2 a1 ~ | % 5
    a1 a1 | % 7
    f2 f8 [ g8 a8 g8 ] a2 bes8 [ a8 g8 f8 ] | % 9
    e1 a2 bes8 [ a8 g8 f8 ] | % 11
    e4 d4 e4 f4 e2 d8 [ c8 d8 b8 ] | % 13
    \time 3/2  | % 13
    cis1. | % 14
    d2 e4 d4 c4 d4 | % 15
    e1. | % 16
...
PartPTwoVoiceOneLyricsOne =  \lyricmode {\set ignoreMelismata = ##t Et
    in "ter " __ "ra " __ _ pax __ _  "ho " __ "mi " __ _ "ni " __ bus
    ...
    "om " __ "ni " __ "po " __ _ _ _ "tens." "D " __ "mi "
    __ "ne " __ _ "Fi " __ _ li "u " __ "ni " __ "gen " __ "i "
    __ "te " __ _ _ _ "Je " __ su "Chri " __ "ste," "Do "
    ...
    su "Chri " __ _ "ste," "Cum " __ _ "Sanc " __ "to " __ _
...
PartPThreeVoiceOne =  \relative a {
    \clef "treble_8" \key c \major \time 4/2 | % 1
    a\breve | % 2
    f\breve | % 3
    g\breve | % 4
    f2 e2 d1 ~ | % 5
...
PartPThreeVoiceOneLyricsOne =  \lyricmode {\set ignoreMelismata = ##t Et
    in "ter " __ "ra " __ _ pax __ _ ho -- mi -- ni -- bus bo -- nae vo
    -- lun -- ta -- "tis," Lau -- da -- mus "te." Be -- ne -- di -- ci
    -- mus "te," A -- do -- ra -- mus "te," "Glo " __ _ ri -- fi --
    ca -- mus "te," _ _ _ _ _ Gra -- ti -- as a
    -- gi -- mus "ti " __ _ _ bi prop -- ter ma -- gnam "glo "
    __ _ "ri " __ am tu -- "am," Do -- mi -- ne De -- "us," Rex coe
    -- les -- "tis," De -- us Pa -- ter om -- ni -- po -- "tens," Do --
    mi -- "ne " __ _ "Fi " __ _ li u -- ni -- ge -- ni -- "te "
    __ _ _ _ Je -- su Chri -- "ste," _ _ _
    _ _ Do -- mi -- ne De -- "us," "A " __ _ gnus De --
    "i," "Fi " __ _ _ _ _ "li " __ _ _ us
    "Pa " __ _ "tris." 
    Qui tol -- lis pec -- ca -- ta mun -- di,
    mi -- se -- re -- re   
    no -- _ _ bis _ _ _ _ _ 
    Qui tol -- lis pec -- ca -- ta "mun " __ _ "di,"
    ...
    __ _ ste _ _ _ _ _ "Cum " __ _ Sanc
...
PartPFourVoiceOne =  \relative d {
    \clef "bass" \key c \major \time 4/2 | % 1
    d\breve | % 2
    d\breve | % 3
    e\breve | % 4
    d2 c2 d1 ~ | % 5
...
PartPFourVoiceOneLyricsOne =  \lyricmode {\set ignoreMelismata = ##t Et
    ...
    -- su "Chris " -- _ ste _ _ _ _ _ "Cum "
    __ _ "Sanc " -- to "Spi " -- ri -- tu, 
