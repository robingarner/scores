...
superiusVI = \transpose \transposeFrom \transposeTo \relative c' {
    \fourTwoCutTime
...
mediusVI = \transpose \transposeFrom \transposeTo \relative c' {
    \fourTwoCutTime
    \key f \major

    R\breve*2 | a2. bf4( c2) a | d1 c | c\breve | c | f,2 a2.( g4 a2 ~ |
        a4 g f1 e2 | d d'2. c4 c2 ~ | c \ficta b) c2 e ~ |
        e d( c2. bf4 | a1. g2) | a f'2. f4 e2 ~ | e
    ...
    g2 g bf a | a1 f2 f' ~ | f f f1 | f2 f1( c2 ~ | c f2.) ef4( c2) |
        d2 d2 c1 | g2 c2.( bf4 g2 | d' c) c1 | r2 c e e | g1 f |

    r2 f1 d2 | bf c d c | d1 c2 f ~ | f4 ef( d2) c1 | bf2 f'1 e2 | e a, c1 |
...
mediusLyricsVI = \lyricmode {
    A -- ve __ Ma -- ri -- a, A -- ve Ma -- ri -- a, Ma -- ri -- a, 
        gra -- ti -- a __ ple -- na, 
        gra -- ti -- a ple -- na, 
        gra -- ti -- a ple -- na, Do -- mi -- nus te -- cum,
        Do -- mi -- nus te -- cum,
    ...
    fru -- ctus ven -- tris tu -- i, 
    et be -- ne -- di -- ctus fru -- ctus ven -- tris tu -- i, 
    fru -- ctus ven -- tris __ tu -- i, fru -- ctus ven -- tris tu -- i,  tu -- i. 
    A -- men.
    A -- men. 
    A -- men.
%    A -- men.
...
contraVI = \transpose \transposeFrom \transposeTo \relative c {
    \fourTwoCutTime
    \key f \major

    f2. g4( a2) f2 | bf1 a | f\breve | f1 f1 | g2( a2. g4 e2 | a1 g2. a4 | 
    ...
    r2 f1 d2 | bf c d c | d1 c2 f ~ | f4 ef( d2) c1 | bf2 f'1 e2  | 
        e a, c2.( bf4) | a1 r2 f | a a c1 | g2 g2 bf2 a | a1 f2 f' ~ | f f
    % --- page ---
    f1 | f2 f1( c2 ~ | c f2.) ef4( c2) | d d c1 | g2 c2.( bf4 g2) | a1 r2 c( | 
        a d1 c2 |
...
contraLyricsVI = \lyricmode {
    A -- ve __ Ma -- ri -- a, A -- ve Ma -- ri -- a, Ma -- ri -- a, Ma -- ri -- a, 
    gra -- ti -- a ple -- na, 
    \ijLyrics
        gra -- ti -- a ple -- na, 
        gra -- ti -- a ple -- na, 
    ...
    \normalLyrics
    et be -- ne -- di -- ctus fru -- ctus ven -- tris tu -- i, 
    fru -- ctus ven -- tris __ tu -- i, fru -- ctus ven -- tris tu -- i,
    et be -- ne -- di -- ctus et be -- ne -- di -- ctus fru -- ctus ven -- tris tu -- i, __
    fru -- ctus ven -- tris tu -- i.
    A -- men.
    \ijLyrics
    A -- men.
...
tenorVI = \transpose \transposeFrom \transposeTo \relative c {
    \fourTwoCutTime
    \key f \major
...
tenorLyricsVI = \lyricmode {
    A -- ve __ Ma -- ri -- a, Ma -- ri -- a, Ma -- ri -- a, 
        gra -- ti -- a ple -- na, 
        gra -- ti -- a ple -- na, Do -- mi -- nus te -- cum,
        Do -- mi -- nus __ te -- cum,
        Do -- mi -- nus te -- cum;
...
bassusVIincipit = \transpose c e \relative c, {
    \time 2/2
    \clef "petrucci-f4"
    \key f \major
...
bassusVI = \transpose \transposeFrom \transposeTo \relative c, {
    \fourTwoCutTime
    \key f \major
...
bassusLyricsVI = \lyricmode {
    ...
    Be -- ne -- di -- cta __ tu,
    be -- ne -- di -- cta __ tu in mu -- li -- e -- ri -- bus,  __
    et be -- ne -- di -- ctus fru -- ctus ven -- tris tu -- i, tu -- i, __
    et be -- ne -- di -- ctus fru -- ctus ven -- tris tu -- i, tu -- i. __
    A -- men.
    A -- men.
    A -- men. 
